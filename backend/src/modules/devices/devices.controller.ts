...
export class DevicesController {
  ...
  @ApiParam({ name: 'device_id', description: 'UUID устройства', example: 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11' })
  @ApiResponse({ status: 200, description: 'Устройство найдено', type: DeviceDto })
