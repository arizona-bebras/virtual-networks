...
ALTER TABLE "devices" ADD COLUMN "keys_id" uuid;--> statement-breakpoint
ALTER TABLE "networks" ADD COLUMN "creator_id" text;--> statement-breakpoint
ALTER TABLE "networks" ADD COLUMN "keys_id" uuid;--> statement-breakpoint
...
ALTER TABLE "networks" ADD CONSTRAINT "networks_keys_id_keys_id_fkey" FOREIGN KEY ("keys_id") REFERENCES "keys"("id") ON DELETE CASCADE;