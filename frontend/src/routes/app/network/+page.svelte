...
function isValidConnection(edge: Edge | Connection) {
  ...
  if (sourceNodeid.startsWith("client"))
    return targetNodeid.startsWith("switch");
  if (sourceNodeid.startsWith("switch"))
    return targetNodeid.startsWith("server");
  return true;
}
...
function getConnectionType(
  ...
  if (source.startsWith("client") && target.startsWith("switch"))
    return "client-switch";
  if (source.startsWith("switch") && target.startsWith("server"))
