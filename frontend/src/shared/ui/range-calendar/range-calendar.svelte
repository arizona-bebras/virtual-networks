...
import type { ButtonVariant } from "$shared/ui/button/index.js";
...
<RangeCalendarPrimitive.Root
  ...
  class={cn(
		"p-2 [--cell-size:--spacing(7)] bg-background group/calendar p-3 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent flex items-center justify-center",
		className
	)}
  {locale}
  {monthFormat}
        ...
        <RangeCalendar.Month>
          <RangeCalendar.Header>
            <!-- <RangeCalendar.Caption
              ...
              {monthIndex}
            /> -->
            <RangeCalendar.MonthSelect aria-label="Select month" class="" />
